...
public class ObjectFactory {
    ...
    private final static QName _SayHelloResponse_QNAME = new QName("http://server.soap.webapp.central.servidor.cure.edu.uy/", "sayHelloResponse");
    private final static QName _SayGoodbye_QNAME = new QName("http://server.soap.webapp.central.servidor.cure.edu.uy/", "sayGoodbye");
    private final static QName _SayGoodbyeResponse_QNAME = new QName("http://server.soap.webapp.central.servidor.cure.edu.uy/", "sayGoodbyeResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.soap.webapp.central.servidor.cure.edu.uy/", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.soap.webapp.central.servidor.cure.edu.uy/", name = "sayGoodbye")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.soap.webapp.central.servidor.cure.edu.uy/", name = "sayGoodbyeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.soap.webapp.central.servidor.cure.edu.uy/", name = "sayHello")
