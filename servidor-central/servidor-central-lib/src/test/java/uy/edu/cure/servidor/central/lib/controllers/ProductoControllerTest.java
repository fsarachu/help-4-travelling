...
public void testAgregar() throws Exception {
    Producto producto1;
    producto1 = new Servicio();
    producto1.setId(1);
    productoController.agregar(producto1);
    assertEquals(producto1, productoController.obtener(producto1.getId()));
...
public void testModificar() throws Exception {
    ...
    public void testEliminar() throws Exception {
        ...
        productoController.agregar(producto1);
        productoController.eliminar(producto1.getId());

        assertNull(productoController.obtener(producto1.getId()));
    }
@Test
